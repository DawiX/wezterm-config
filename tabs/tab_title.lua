...
local GLYPH_SARROW_LEFT = nf.ple_trapezoid_top_bottom_mirrored --[[  ]]
local GLYPH_SARROW_RIGHT = nf.pl_left_hard_divider --[[  ]]
...
-- stylua: ignore
local colors = {
  text_default          = { bg = '#3C3836', fg = '#BABABA' },
  text_hover            = { bg = '#FABD2F', fg = '#1C1B19' },
  text_active           = { bg = '#9C9F04', fg = '#11111B' },

  unseen_output_default = { bg = '#45475A', fg = '#FE8019' },
  unseen_output_hover   = { bg = '#FABD2F', fg = '#FE8019' },
  unseen_output_active  = { bg = '#FABD2F', fg = '#FE8019' },

  scircle_default       = { bg = '#3C3836', fg = '#3C3836' },
  scircle_hover         = { bg = '#3C3836', fg = '#FABD2F' },
  scircle_active        = { bg = '#3C3836', fg = '#9C9F04' },
}
...
function Tab:create_cells()
  self.cells
      :add_segment("scircle_left", GLYPH_SARROW_LEFT)
      ...
      :add_segment("padding", " ")
      :add_segment("scircle_right", GLYPH_SARROW_RIGHT)
end
